...
<section>
    ...
    ?>
        ...
        <form class="update_form" action="./admin/updateUserConfig.php" method="POST">
                ...
                <input required placeholder='<?php echo"$fname";?>' type="text" name="fname">
                </div>
                <div class="input-field">
                <label>Last Name</label>
                <input required placeholder='<?php echo"$lname";?>' type="text" name="lname">
                </div>
                <div class="input-field">
                <label>User Name</label>
                <input required placeholder='<?php echo"$username";?>' type="text" name="username">
                </div>
                <div class="input-field">
                <label>Email</label>
                <input required placeholder='<?php echo"$email";?>' type="email" name="email">
                </div>
